    ...
    <div class="col-lg-8">
      ...
      @if (empty($post->image))
        <div class="d-flex justify-content-center mt-3 img-fluid" style="max-height: 300px; max-width:100%; overflow: hidden;">
          <img src="/img/post-1.jpg" class="object-fit-contain" alt="{{ $post->category->name }}">
        </div>
      @else
        <div class="d-flex justify-content-center mt-3 img-fluid" style="max-height: 300px; max-width:100%; overflow: hidden;">
          <img src="{{ secure_asset('img/' . $post->image) }}" class="object-fit-contain" alt="{{ $post->category->name }}">
        </div>
      @endif
